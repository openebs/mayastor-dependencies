use crate::blkid::{
    ...
    blkid_new_probe_from_filename, blkid_probe, blkid_probe_has_value, blkid_probe_lookup_value,
};
use core::slice;
use std::{
    ffi::{CStr, CString},
...
impl Probe {
    ...
    pub fn new_from_filename<P: AsRef<Path>>(path: P) -> Result<Probe, DevInfoError> {
