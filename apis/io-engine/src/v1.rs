...
pub mod pool {
    pub use super::pb::{
        ...
        ImportPoolRequest, ListPoolHealthOptions, ListPoolHealthResponse, ListPoolOptions,
        ListPoolsResponse, NvmeErrorLogEntry, Pool, PoolAlert, PoolAlertStatus, PoolAlerts,
        PoolErrors, PoolHealth, PoolMetadataArgs, PoolMetadataInfo, PoolProbes, PoolState,
